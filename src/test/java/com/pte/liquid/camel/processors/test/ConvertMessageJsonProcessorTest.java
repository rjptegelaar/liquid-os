...
public class ConvertMessageJsonProcessorTest extends CamelTestSupport{
	
	@Autowired
	private ConvertMessageJsonProcessor convertMessageJsonProcessor;
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            public void configure() throws IOException {            	
            	from("direct:start").process(convertMessageJsonProcessor).to("mock:result");
            }
        };
    }
